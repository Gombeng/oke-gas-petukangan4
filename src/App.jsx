...
function App() {
  ...
  return (
    <Container maxW="sm" pb={4}>
      <Box bg={"blue.500"} p={4} borderBottomRadius={"md"} mb={2} color="white">
      ...
      >
        <Box>
          <Text>Syahrizal Ardana</Text>
          <Text>+6282285598500</Text>
        </Box>

        <Button
          as={Link}
          href="http://wa.me/6282285598500"
          target="_blank"
          color={"white"}
          bg="green.300"
          _hover={{ bg: "green.400" }}
      ...
      <SummaryCard income={income} expense={expense} ballance={ballance} />
...
const SummaryCard = ({ income, expense, ballance }) => {
  return (
    <Box>
      <Flex
        gap={2}
